...
hmodel = joblib.load('model/model_House_prices_.pkl')
...
#             saving uploaded file
            ...
            df__ =df.copy()
            X_ =df__[['location', 'total_sqft', 'bathroom', 'bhk']]
            y_ =df__['price']

            le_ =LabelEncoder()
            X_['location']=le_.fit_transform(X_['location'])
